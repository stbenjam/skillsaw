...
<p align="center"><a href="https://skillsaw.org/"><img src="https://raw.githubusercontent.com/stbenjam/skillsaw/main/.skillsaw-card.svg" alt="skillsaw report card" width="495"></a></p>
<p align="center"><sub>skillsaw's own report card, generated by <code>skillsaw badge --large</code></sub></p>
...
>
> The plugin also ships the `skillsaw-lint` skill: whenever your agent writes or edits agentic context (a skill, command, agent, hook, or instruction file), it lints and improves that file before reporting the work done.
>
