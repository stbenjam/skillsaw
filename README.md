...
GEMINI.md, QWEN.md, Cursor, Copilot, Cline, Kiro, Roo, hooks, agent
configuration, and evals. Safe structural fixes can be applied automatically; everything else
comes with precise, agent-friendly guidance.
