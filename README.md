...
<p align="center"><sub>Report card for <code>openshift-eng/ai-helpers</code>, generated by <code>skillsaw badge --card</code></sub></p>
...
```bash
skillsaw badge --card .               # dark theme (default)
skillsaw badge --card --theme light .
```
