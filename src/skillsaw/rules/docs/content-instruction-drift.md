...
`similarity-max-sections` caps the number of qualifying sections compared across files (default 400).
Raise this setting if you maintain an unusually large monorepo.
