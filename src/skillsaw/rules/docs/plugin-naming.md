...
listing — is exempt: Claude never loads it, so codex-plugin-json-valid already checks the manifest name, and a second directory-name report would double up. A dual-manifest
