...
prompt limit. Omitted `target` means both environments and accepts the
documented union. Unknown tool names remain valid because both consumers
ignore tools they do not provide.
