...
whitespace is stripped), the autofix does this for you. It is SUGGEST, not
SAFE — replacing a file's contents is a judgment call — and anything that
is not an exact copy is reported only.
