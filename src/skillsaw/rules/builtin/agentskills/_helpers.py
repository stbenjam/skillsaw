...
# hyphen — digit-leading names like "3d-printing" are valid. The lookahead
# requires at least one letter: purely numeric names fail the reference
# validator's lowercase check ("123".islower() is False).
