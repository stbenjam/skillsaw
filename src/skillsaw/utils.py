...
#: literally, not by pattern: three attempts at a heuristic here each let
#: authored prose through and dropped a real file out of the lint tree —
#: first the phrase anywhere in the document, then the phrase on any
#: comment-ish line, which in Markdown includes every `#` heading.
