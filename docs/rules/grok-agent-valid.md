...
.grok/agents/*.md must declare a name and a description in frontmatter
...
*Run `skillsaw explain grok-agent-valid` to see this documentation and the rule's effective configuration in your terminal.*
