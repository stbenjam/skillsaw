...
| **Autofix** | - |
| **Since** | v0.18.0 |
| **Repo Types** | agentskills, antigravity, antigravity-plugin, apm, codex-marketplace, codex-plugin, copilot, dot-claude, grok-marketplace, grok-plugin, grok-project, marketplace, opencode, single-plugin |
