...
Agent frontmatter enum fields (permissionMode, memory, effort, isolation, color) must use documented values, and plugin-shipped agents must not declare hooks, mcpServers, or permissionMode
