...
| [`content-broken-external-reference`](content-broken-external-reference.md) | Detect external http(s) links whose server reports them gone (404/410) | warning (disabled) | - |
