...
|-----------|-------------|---------|
| `extra-tables` | Additional top-level table names to accept, for tables a Grok release honours at project scope that this skillsaw release has not heard of | `[]` |
