...
| [`content-progressive-disclosure`](content-progressive-disclosure.md) | Long skills and instruction files should use progressive disclosure: split detail into referenced files that load on demand | info (auto) | - | Content Intelligence |
