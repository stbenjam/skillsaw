...
- [Plugin Structure](claude-code/plugin-structure.md) (4 rules)
- [Command Format](claude-code/command-format.md) (4 rules)
- [Marketplace](claude-code/marketplace.md) (2 rules)
- [Agents](claude-code/agents.md) (1 rule)
- [Hooks](claude-code/hooks.md) (1 rule)
- [MCP (Model Context Protocol)](claude-code/mcp.md) (2 rules)
- [Rules Directory](claude-code/rules-directory.md) (1 rule)
