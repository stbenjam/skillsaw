...
| [`codex-plugin-structure`](codex-plugin-structure.md) | .codex-plugin/ should contain only its manifest and referenced interface assets | warning (auto) | - | OpenAI Codex |
