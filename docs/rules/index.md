...
- [OpenAI Codex Plugins](codex-plugins.md) (4 rules)
...
| [`codex-plugin-json-required`](codex-plugin-json-required.md) | Codex plugins must have .codex-plugin/plugin.json | error (auto) | - | OpenAI Codex Plugins |
| [`codex-plugin-json-valid`](codex-plugin-json-valid.md) | Codex plugin.json must follow the documented manifest format | error (auto) | - | OpenAI Codex Plugins |
| [`codex-marketplace-json-valid`](codex-marketplace-json-valid.md) | Codex marketplace.json must follow the documented catalog format | error (auto) | - | OpenAI Codex Plugins |
| [`codex-marketplace-registration`](codex-marketplace-registration.md) | Local Codex plugins must be registered in marketplace.json | error (auto) | - | OpenAI Codex Plugins |
