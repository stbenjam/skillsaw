...
| [`roo-modes-valid`](roo-modes-valid.md) | Roo .roomodes custom modes must declare the fields Roo needs to load them | error (auto) | - | Roo (legacy) |
