...
| [`content-inline-tool-examples`](content-inline-tool-examples.md) | Detect runs of fenced examples invoking one tool with varying arguments | info (disabled) | - | Content Intelligence |
