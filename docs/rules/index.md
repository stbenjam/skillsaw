...
| [`antigravity-config-json-valid`](antigravity-config-json-valid.md) | Antigravity registry JSON files (skills.json, agents.json, rules.json) under .agents/ or .agent/ must be valid JSON objects | error (disabled) | - | Google Antigravity |
...
| [`antigravity-mcp-valid`](antigravity-mcp-valid.md) | Antigravity mcp_config.json must declare valid MCP server configurations with supported transports ('serverUrl' or 'command') | error | - | Google Antigravity |
