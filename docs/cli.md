...
| `--type` | Override auto-detected repository type (repeatable). Values: single-plugin, marketplace, codex-plugin, codex-marketplace, agentskills, dot-claude, coderabbit, apm, promptfoo. |  |
