...
removed rules), update these in the same PR:

- **README.md** — the Builtin Rules table and any relevant prose (e.g.
  configuration examples, directory structure diagrams).
- **`.apm/instructions/development.md`** — if the change affects development
  conventions or architecture notes.

Then run `make apm` to regenerate `.claude/`.
